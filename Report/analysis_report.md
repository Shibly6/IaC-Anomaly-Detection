...
- **Source File**: `IaC_script/s3_public_acl_extra_new_4.tf`
...
- **Source File**: `IaC_script/s3_public_acl_extra_new_1.tf`
- **Ensemble Score**: 0.750
- **Public ACL**: Yes
- **Public Policy**: No
...
- **Source File**: `IaC_script/s3_public_acl_new_4.tf`
- **Ensemble Score**: 0.750
- **Public ACL**: Yes
- **Public Policy**: No
...
- **Source File**: `IaC_script/s3_public_acl_extra_new_6.tf`
- **Ensemble Score**: 0.750
- **Public ACL**: Yes
- **Public Policy**: No
...
- **Source File**: `IaC_script/s3_public_read_write.tf`
- **Ensemble Score**: 0.750
- **Public ACL**: Yes
- **Public Policy**: No
...
- **Source File**: `IaC_script/s3_public_acl_new_2.tf`
- **Ensemble Score**: 0.750
- **Public ACL**: Yes
- **Public Policy**: No
